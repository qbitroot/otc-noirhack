_*Note: this is a legacy version of an early prototype of the project built with vanilla Noir circuits only. Please see the new version built with Aztec L2.*_
